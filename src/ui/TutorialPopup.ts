...
export class TutorialPopup {
    ...
    showMessage(title: string, message: string): void {
        ...
        this.container.innerHTML = `
            ...
            ">
                <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
                    <h2 style="color: #ff4444; margin: 0; font-size: 24px;">⚠️ ${title}</h2>
                    <button id="tutorial-close" style="
                        background: transparent;
                        border: none;
                        color: #ff4444;
                ...
                <button id="tutorial-got-it" style="
                    ...
                    width: 100%;
                    transition: all 0.3s;
                " onmouseover="this.style.background='#ff6666'" onmouseout="this.style.background='#ff4444'">Got it</button>
            </div>
        `;
